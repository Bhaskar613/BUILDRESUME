export const landingPageStyles = {
  ...
  // Header styles
  header: "fixed top-0 w-full  flex flex-row z-50 bg-white/70 backdrop-blur-xl border-b border-violet-100/50",
  headerContainer:  "w-full max-w-7xl mx-auto flex justify-between items-center px-6 lg:px-12 py-4",
  ...
  heroGrid: "flex flex-wrap justify-between gap-10 lg:gap-12 items-center lg:flex-nowrap",
  heroLeft: "space-y-8",
